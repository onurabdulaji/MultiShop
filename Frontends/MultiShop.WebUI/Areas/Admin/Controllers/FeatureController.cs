...
public class FeatureController(IHttpClientFactory _httpClientFactory) : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        ViewBag.v2 = "One Cikan Alanlar";
        ViewBag.v3 = "One Cikan Listesi";
        ViewBag.v0 = "Ana Sayfa One Cikan Islemleri";
    ...
    public async Task<IActionResult> CreateFeature(CreateFeatureDto createFeatureDto)
    {
        ...
        var responeMessage = await client.PostAsync("https://localhost:7070/api/Features", stringContent);
